...
import type { DrawingState, PolygonCoords, BackendResponse } from "@/lib/types";
...
import { sendPolygonToBackend, fetchAreaName } from "@/lib/api";
      ...
      if (currentPolygonVertices.length > 2) {
        ...
        (async () => {
          try {
            ...
            console.log("[v0] Backend response:", resp);
